...
public class TestWebsocketHandler extends TextWebSocketHandler{
	...
	// 동기화된 Set 생성
	private Set<WebSocketSession> sessions = Collections.synchronizedSet(new HashSet<>()); // 줄 세운 Set , 일관성 유지
	...
	public void afterConnectionEstablished(WebSocketSession session) throws Exception {
		...
		// 매개변수로 받고 있는 WebSocketSession은 SessionHandshakeInterceptor가 가로챈 것
