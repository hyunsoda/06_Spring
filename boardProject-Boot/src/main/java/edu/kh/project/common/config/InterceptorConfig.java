...
public class InterceptorConfig implements WebMvcConfigurer{ // WebMvcConfigurer : Spring과 관련된 각종 기능들을 overriding해서 사용
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		.addPathPatterns("/**") // 가로챌 요청 주소를 지정     다른 주소들 쓸 때는 , "" 쓰면 됨
								// /** : / 이하의 모든 요청 주소
		// 가로채지 않을 주소를 지정
